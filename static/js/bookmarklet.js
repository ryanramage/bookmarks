...
/**
 *
 * Displays the bookmarklet using jquery and jquery templates
 *
 * @param {Object} window
 */
(function(window){
    ...
    function couchBookmarkerBookmarklet(){
        ...
        $('#w3c-nav-iframe').attr('src', couch_location + '/bookmark_lite?url=' + doc.url + '&title=' + doc.title);
