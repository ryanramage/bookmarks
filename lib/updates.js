...
exports.bookmark = function(doc, req) {
    ...
    if (req.body && req.body.length > 0) {
        ...
        details.title = decodeWWWform(details.title);
        details.url = decodeWWWform(details.url);
        if (details.short_text) {
            details.short_text = decodeWWWform(details.short_text);
        }
    }
